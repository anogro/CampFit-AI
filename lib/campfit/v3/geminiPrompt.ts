...
export function buildConversationPrompt(input: AnalyzeConversationInput): string {
  ...
  return [
    ...
    JSON.stringify({
      ...
      childEnglishListening: { subject: "child", values: ["understands_simple_instructions", "understands_class_explanation", "unknown"] },
      childEnglishSpeaking: { subject: "child", values: ["answers_simple_questions", "can_converse", "initiates_speech", "difficulty_initiating", "rarely_speaks", "unknown"] },
